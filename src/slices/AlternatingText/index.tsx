...
const AlternatingText = ({ slice }: AlternatingTextProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="alternating-text-container relative text-sky-950 bg-yellow-200"
    >
      <div>
        <div className="grid relative z-[100]">
          ...
          {slice.primary.text_group.map((item, index) =>(
            <div 
              key={asText(item.heading)} className="alternating-section grid h-screen place-items-center gap-x-12 md:grid-cols-2"
            >
